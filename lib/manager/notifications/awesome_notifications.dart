...
class NotificationController {
  ...
  /// SMS notif
  static Future<void> createNewNotificationSMS(String title, String body) async {
    bool isAllowed = await AwesomeNotifications().isNotificationAllowed();
    if (!isAllowed) isAllowed = await displayNotificationRationale();
    if (!isAllowed) return;
    ...
    await AwesomeNotifications().createNotification(
        content: NotificationContent(
            ...
            body: body,
            //bigPicture: 'https://storage.googleapis.com/cms-storage-bucket/d406c736e7c4c57f5f61.png',
            largeIcon: 'https://cdn-icons-png.flaticon.com/512/3258/3258446.png',
            //'asset://assets/images/balloons-in-sky.jpg',
...
class NotifPage extends StatefulWidget {
  const NotifPage({super.key, required this.title});
  final String title;
        ...
        child: Row(
          ...
          children: [
            ...
            FloatingActionButton(
              ...
              onPressed: () => NotificationController.createNewNotificationSMS('title','body body body body body body body body body body body body body body '),
